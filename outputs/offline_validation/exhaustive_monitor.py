...
import sys
started=time.time();results=json.loads(Path(str(Path(__file__).resolve().parent / "results") + "/monitor_execution_progress.json").read_text()) if "--resume" in sys.argv else []
